<div>
    ...
    <form class="max-w-sm " wire:submit="edit">
        <div class="mb-5">
            <label for="nome" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nome Fantasia</label>
            <input type="text" id="nome" wire:model="nome" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5  dark:border-gray-600  dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Nome fantasia" required />
        </div>

        <div class="mb-5">
            <label for="razaoSocial" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Razao Social</label>
